...
!function (t) {
    ...
    return function t(e, i, n) {
        ...
        1: [function (t, e, i) {
            ...
            var r = t(2), l = "addEventListener"in window, c = !1;
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = function (t, e) {
                var i = this;
            ...
            var s = window.jQuery, o = t(2), a = function (t, e) {
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = n(document), a = function (t, e) {
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = n(document), a = s.support.transition, r = function () {
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = s.support.animation, a = function (t, e) {
            ...
            n.flexslider = function (t, e) {
                ...
                var s, o = i.vars.namespace, a = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, r = ("ontouchstart"in window || a || window.DocumentTouch && document instanceof DocumentTouch) && i.vars.touch, l = "click touchend MSPointerUp keyup", c = "", u = "vertical" === i.vars.direction, h = i.vars.reverse, d = i.vars.itemWidth > 0, p = "fade" === i.vars.animation, m = "" !== i.vars.asNavFor, f = {}, v = !0;
                n.data(t, "flexslider", i), f = {
                    init: function () {
                        ...
                        setup: function () {
                            i.asNav = !0, i.animatingTo = Math.floor(i.currentSlide / i.move), i.currentItem = i.currentSlide, i.slides.removeClass(o + "active-slide").eq(i.currentItem).addClass(o + "active-slide"), a ? (t._slider = i, i.slides.each(function () {
                                ...
                                t.preventDefault();
                                var e = n(this), s = e.index(), a = e.offset().left - n(i).scrollLeft();
                        ...
                        setup: function () {
                            ...
                            var t, e, s = "thumbnails" === i.vars.controlNav ? "control-thumbs" : "control-paging", a = 1;
                            if (i.controlNavScaffold = n('<ol class="' + o + "control-nav " + o + s + '"></ol>'), i.pagingCount > 1)for (var r = 0; r < i.pagingCount; r++) {
                            ...
                            i.controlsContainer ? n(i.controlsContainer).append(i.controlNavScaffold) : i.append(i.controlNavScaffold), f.controlNav.set(), f.controlNav.active(), i.controlNavScaffold.delegate("a, img", l, function (t) {
                                if (t.preventDefault(), "" === c || c === t.type) {
                                    var e = n(this), s = i.controlNav.index(e);
                        ...
                        function s(e) {
                            if (t.removeEventListener("touchmove", n, !1), i.animatingTo === i.currentSlide && !y && null !== g) {
                                var o = h ? -g : g, a = i.getTarget(o > 0 ? "next" : "prev");
                        ...
                        function r(e) {
                            ...
                            if (i) {
                                var n = -e.translationX, s = -e.translationY;
                        ...
                        var e = n(i.vars.sync).data("flexslider"), s = i.animatingTo;
                        switch (t) {
                            case"animate":
                    ...
                    var s = function () {
                        var n = t ? t : (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo, s = function () {
                    ...
                    if (p)i.slides.css({
                        ...
                        display: "block",
                        zIndex: 1
                    }).eq(i.currentSlide).css({zIndex: 2}).animate({opacity: 1}, i.vars.animationSpeed, i.vars.easing)), i.vars.smoothHeight && f.smoothHeight(); else {
                        var e, s;
                    ...
                    var t = i.slides.first(), e = i.vars.itemMargin, n = i.vars.minItems, s = i.vars.maxItems;
            ...
            var s = (window.jQuery, t(2)), o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
            ...
            var s = window.jQuery, o = t(2), a = t(8), r = s(document), l = o.support.transition, c = function (t, e) {
            ...
            c.DEFAULTS = {
                ...
                var t = this.options, e = this, i = this.$element, n = i.find(".am-modal-prompt-input"), o = i.find("[data-am-modal-confirm]"), r = i.find("[data-am-modal-cancel]"), l = function () {
                    var t = [];
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = function (t) {
                var e = function (e, i) {
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = n(window), a = function (t, e) {
            ...
            "use strict";
            var n = (window.jQuery, t(2)), s = function () {
                function t(t, e, i) {
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = t(14), a = t(30), r = s.support.animation, l = s.support.transition, c = function (t, e) {
            ...
            "use strict";
            t(12);
            var n = window.jQuery, s = t(2), o = t(31), a = document, r = n(a), l = function (t) {
            ...
            l.DEFAULTS = {
                ...
                qq: {title: "QQ \u597d\u53cb", url: "http://connect.qq.com/widget/shareqq/index.php", icon: "qq"},
                qzone: {
                    title: "QQ \u7a7a\u95f4",
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = s.utils.rAF, a = s.utils.cancelAF, r = !1, l = function (t, e) {
                function i(t) {
            ...
            var s = window.jQuery, o = t(2), a = t(30), r = o.support.transition, l = o.support.animation, c = function (t, e) {
            ...
            o.DEFAULTS = {
                ...
                var t = this, e = this.$element, i = this.options, s = e.find(i.allFields), o = [], a = !0, r = [], l = n([]), c = [], u = !1;
            ...
            function k(t, e) {
                ...
                var o = i.firstInput, a = i.firstMultiple, r = a ? a.center : o.center, l = e.center = M(n);
            ...
            function F(t, e) {
                ...
                if (e.eventType != Ft && (r > Et || void 0 === a.velocity)) {
                    var l = a.deltaX - e.deltaX, c = a.deltaY - e.deltaY, u = $(r, l, c);
            ...
            function A(t) {
                ...
                return {timeStamp: mt(), pointers: e, center: M(e), deltaX: t.deltaX, deltaY: t.deltaY}
            }
            ...
            var rt = window.jQuery, lt = t(2), ct = ["", "webkit", "moz", "MS", "ms", "o"], ut = document.createElement("div"), ht = "function", dt = Math.round, pt = Math.abs, mt = Date.now, ft = 1, vt = /mobile|tablet|ip(ad|hone|od)|android/i, gt = "ontouchstart"in window, wt = void 0 !== b(window, "PointerEvent"), yt = gt && vt.test(navigator.userAgent), bt = "touch", Tt = "pen", xt = "mouse", Ct = "kinect", Et = 25, St = 1, kt = 2, Dt = 4, Ft = 8, At = 1, Mt = 2, $t = 4, Pt = 8, Nt = 16, It = Mt | $t, Ot = Pt | Nt, Lt = It | Ot, zt = ["x", "y"], _t = ["clientX", "clientY"];
            C.prototype = {
                handler: function () {
                }, init: function () {
            ...
            var jt = {
                ...
                touchend: Dt,
                touchcancel: Ft
            }, Xt = "touchstart", Yt = "touchstart touchmove touchend touchcancel";
            l(R, C, {
                handler: function (t) {
                    var e = jt[t.type];
            ...
            var Gt = b(ut.style, "touchAction"), Jt = void 0 !== Gt, Kt = "compute", te = "auto", ee = "manipulation", ie = "none", ne = "pan-x", se = "pan-y";
            U.prototype = {
                set: function (t) {
            ...
            j.prototype = {
                ...
                defaults: {event: "swipe", threshold: 10, velocity: .65, direction: It | Ot, pointers: 1},
                getTouchAction: function () {
            ...
            var c = window.jQuery, u = t(2), h = [], d = function (t) {
            ...
            var s, o = t(2), a = {}, r = window, l = "localStorage";
            ...
            var s = window.jQuery, o = t(2);
            t(6), s(n), e.exports = o.accordion = {VERSION: "2.1.0", init: n}
            ...
            var s = window.jQuery, o = t(2);
            s(window).on("load", n), e.exports = o.duoshuo = {VERSION: "2.0.1", init: n}
            ...
            }, s(window).on("load", n), e.exports = o.figure = {VERSION: "2.0.3", init: n}
            ...
            t(12);
            var a = t(3), r = t(27);
            s(n), e.exports = o.footer = {VERSION: "3.1.2", init: n}
            ...
            var s = window.jQuery, o = t(2);
            t(17), s(n), e.exports = o.gallery = {VERSION: "3.0.0", init: n}
            ...
            var s = window.jQuery, o = t(2);
            t(22), s(n), e.exports = o.gotop = {VERSION: "4.0.2", init: n}
            ...
            var s = window.jQuery, o = t(2);
            s(n), e.exports = o.header = {VERSION: "2.0.0", init: n}
            ...
            function s() {
                ...
                var d = {
                    width: 200,
                    title: n
                }, p = new BMap.InfoWindow("\u5730\u5740\uff1a" + s, d), m = new BMap.Geocoder;
            ...
            var o = window.jQuery, a = t(2), r = function () {
                o(".am-map").length && n(s)
            };
            o(r), e.exports = a.map = {VERSION: "2.0.2", init: r}
            ...
            var s = window.jQuery, o = t(2);
            s(window).on("load", n), e.exports = o.mechat = {VERSION: "2.0.1", init: n}
        }, {2: 2}], 45: [function (t, e, i) {
            "use strict";
            var n = window.jQuery, s = t(2), o = t(11);
            t(13), t(6);
            var a = function () {
            ...
            n(a), e.exports = s.menu = {VERSION: "4.0.3", init: a}
            ...
            var s = window.jQuery, o = t(2), a = t(21), r = t(31);
            t(12), s(n), e.exports = o.navbar = {VERSION: "2.0.2", init: n}
        }, {12: 12, 2: 2, 21: 21, 31: 31}], 47: [function (t, e, i) {
            "use strict";
            var n = t(2);
            e.exports = n.pagination = {VERSION: "3.0.1"}
            ...
            var s = window.jQuery, o = t(2), a = t(11);
            ...
            }, s(window).on("load", n), e.exports = o.paragraph = {VERSION: "2.0.1", init: n}
            ...
            var s = window.jQuery, o = t(2);
            t(10), s(n), e.exports = o.slider = {VERSION: "3.0.1", init: n}
            ...
            var s = window.jQuery, o = t(2);
            t(24), s(n), e.exports = o.tab = {VERSION: "4.0.1", init: n}
        }, {2: 2, 24: 24}], 51: [function (t, e, i) {
            "use strict";
            var n = t(2);
            e.exports = n.titlebar = {VERSION: "4.0.1"}
            ...
            var s = window.jQuery, o = t(2), a = window.navigator.userAgent.indexOf("MicroMessenger") > -1, r = n;
            s(r), e.exports = o.pay = {VERSION: "1.0.0", init: r}
        }, {2: 2}]
    }, {}, [1])(1)
});