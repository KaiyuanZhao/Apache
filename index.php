                    ...
                    <fieldset>
                        ...
                        <form id="login_form">
                            <div class="am-form-group">
                                ...
                                <input class="input" name="lemail" type="email" id="lemail"
                                       data-validation-message="这个邮箱貌似不属于百姓网或地球...请重新输入" placeholder="输入邮箱" required/>
                            </div>

                            <div class="am-form-group">
                                <label class="hint" for="lpassword">请输入密码：</label>
                                <input class="input" type="password" id="lpassword"
                    ...
                    <fieldset>
                        ...
                        <form id="signup_form">
                            <div class="am-form-group">
                                ...
                                <input class="input" name="semail" type="email" id="semail"
                                       data-validation-message="这个邮箱貌似不属于百姓网或地球...请重新输入" placeholder="输入邮箱" required/>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <input class="input" name="susername" type="text" id="susername" minlength="2"
                                       pattern=[\u4e00-\u9fa5] data-validation-message="请确保正确的中文字符及字符数"
                                       placeholder="输入用户名（至少 2 个的中文字符）" required/>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <input class="input" name="slocation" type="text" id="slocation" minlength="2"
                                       ...
                                       placeholder="请输入四位楼层房间编号（如:0206，1808)" required/>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <input class="input" name="savator" type="file" id="savator"
                                       data-validation-massage="Ops...文件大小不正确"/>
                            </div>
